...
export default function Gallery() {
  ...
  return (
    <div id="fotos">
      <h2 className="page-title text-center">Nosso espaço</h2>

      {isMobile ? (
        <MobileCarousel />
      ) : (
        <div className="relative px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
          {
            <div
              className={` grid grid-flow-row gap-4 text-neutral-600 cursor-pointer sm:grid-cols-2 xl:grid-cols-4 ${
                isMobile
                  ? "hidden"
                  : "grid grid-flow-row gap-4 text-neutral-600 cursor-pointer sm:grid-cols-2  xl:grid-cols-4"
              }`}
            >

...
export default function Home() {
  return (
    <section>
        ...
        <section
          class="cover bg-blue-teal-gradient relative bg-blue-800 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex
      items-center "
        >
          <div class="h-full absolute top-0 left-0 z-0">
            <img
              ...
              alt="Fundo da AFEUP"
              class=" h-[900px] object-cover opacity-20"
            />
          </div>
          ...
          <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
            <div>
              ...
              <a
              className="px-8 py-4 bg-teal-500 text-white rounded inline-block mt-8 font-semibolds"
                href="#contato"
              >
                Reservar local
              </a>
